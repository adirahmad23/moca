          ...
          <div class="col-lg-11 mb-lg-4 mb-4">
            <div class="card z-index-2 h-100 mx-auto p-4" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
              <div class="card-header pb-0 bg-transparent">
                <h6 class="text-center text-capitalize">Cetak Laporan</h6>
              </div>
                  ...
                  <div class="col-lg-12 mb-lg-4 mb-4">
                    <div class="row text-center">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="card p-3 bg-light rounded shadow-sm w-100">
                          <!-- Header Card -->
                          <div class="card-header bg-transparent text-center">
                            <h4 class="font-weight-bold">Laporan AQ 1</h4>
                          </div>
                          ...
                          <div class="card-body">
                            <form method="get" action="reportexcel.php" class="d-flex flex-column align-items-start w-100">
                              ...
                              <div class="form-group d-flex align-items-center mb-3 w-100">
                                ...
                                <input type="time" id="filterStartTime" name="filterStartTime" class="form-control ml-2" required value="<?php echo $filterStartTime; ?>">
                              </div>

                              <!-- Filter End Date and Time -->
                              <div class="w-100 text-center">
                                <label for="filterEndDate" class="text-center w-100">End</label>
                              </div>
                              <div class="form-group d-flex align-items-center mb-3 w-100">
                                <input type="date" id="filterEndDate" name="filterEndDate" class="form-control" required value="<?php echo $filterEndDate; ?>">
                                <input type="time" id="filterEndTime" name="filterEndTime" class="form-control ml-2" required value="<?php echo $filterEndTime; ?>">
                              </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="card p-3 bg-light rounded shadow-sm w-100">
                          <!-- Header Card -->
                          <div class="card-header bg-transparent text-center">
                            <h4 class="font-weight-bold">Laporan AQ 2</h4>
                          </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="card p-3 bg-light rounded shadow-sm w-100">
                          <!-- Header Card -->
                          <div class="card-header bg-transparent text-center">
                            <h4 class="font-weight-bold">Laporan AQ 3</h4>
                          </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="card p-3 bg-light rounded shadow-sm w-100">
                          <!-- Header Card -->
                          <div class="card-header bg-transparent text-center">
                            <h4 class="font-weight-bold">Laporan CEMS 1</h4>
                          </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="card p-3 bg-light rounded shadow-sm w-100">
                          <!-- Header Card -->
                          <div class="card-header bg-transparent text-center">
                            <h4 class="font-weight-bold">Laporan CEMS 2</h4>
                          </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 mb-3">
                        <div class="card p-3 bg-light rounded shadow-sm w-100">
                          <!-- Header Card -->
                          <div class="card-header bg-transparent text-center">
                            <h4 class="font-weight-bold">Laporan CEMS 3</h4>
                          </div>
