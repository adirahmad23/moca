...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if 'barat' is selected and redirect to the email page
    if ($selectedWindDirection === 'barat') {
        header("Location: https://moca-emission.id/email.php");
        exit();
    }
...
<div class="container mt-5">
    ...
    <form action="" method="post">
        ...
        <input type="submit" class="btn btn-info" value="Email" name="email">
    </form>
</div>
